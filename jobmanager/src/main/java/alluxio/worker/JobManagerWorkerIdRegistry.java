...
public final class JobManagerWorkerIdRegistry {
  ...
  private JobManagerWorkerIdRegistry() {}

  /**
   * Registers with {@link JobManagerMaster} to get a new worker id.
   *
   ...
   */
  public static void registerWithJobManagerMaster(JobManagerMasterClient masterClient,
