...
public class JobManagerMasterWorkerService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public List<JobManangerCommand> heartbeat(long workerId, List<TaskStatus> taskStatusList) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;

  }

  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {

    public void heartbeat(long workerId, List<TaskStatus> taskStatusList, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public List<JobManangerCommand> heartbeat(long workerId, List<TaskStatus> taskStatusList) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_heartbeat(workerId, taskStatusList);
      return recv_heartbeat();
    }

    public void send_heartbeat(long workerId, List<TaskStatus> taskStatusList) throws org.apache.thrift.TException
    {
      heartbeat_args args = new heartbeat_args();
      args.setWorkerId(workerId);
      args.setTaskStatusList(taskStatusList);
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void heartbeat(long workerId, List<TaskStatus> taskStatusList, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      heartbeat_call method_call = new heartbeat_call(workerId, taskStatusList, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class heartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public heartbeat_call(long workerId, List<TaskStatus> taskStatusList, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class heartbeat<I extends Iface> extends org.apache.thrift.ProcessFunction<I, heartbeat_args> {
      ...
      public heartbeat_result getResult(I iface, heartbeat_args args) throws org.apache.thrift.TException {
        heartbeat_result result = new heartbeat_result();
        try {
          result.success = iface.heartbeat(args.workerId, args.taskStatusList);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class heartbeat<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, heartbeat_args, List<JobManangerCommand>> {
      ...
      public void start(I iface, heartbeat_args args, org.apache.thrift.async.AsyncMethodCallback<List<JobManangerCommand>> resultHandler) throws TException {
        iface.heartbeat(args.workerId, args.taskStatusList,resultHandler);
      }
    }
  ...
  public static class heartbeat_args implements org.apache.thrift.TBase<heartbeat_args, heartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TASK_STATUS_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("taskStatusList", org.apache.thrift.protocol.TType.LIST, (short)2);
    ...
    private List<TaskStatus> taskStatusList; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
       ...
       */
      TASK_STATUS_LIST((short)2, "taskStatusList");
    ...
    static {
      ...
      tmpMap.put(_Fields.TASK_STATUS_LIST, new org.apache.thrift.meta_data.FieldMetaData("taskStatusList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public heartbeat_args(heartbeat_args other) {
      ...
      if (other.isSetTaskStatusList()) {
        List<TaskStatus> __this__taskStatusList = new ArrayList<TaskStatus>(other.taskStatusList.size());
        for (TaskStatus other_element : other.taskStatusList) {
          __this__taskStatusList.add(new TaskStatus(other_element));
        }
        this.taskStatusList = __this__taskStatusList;
      }
    }
    ...
    public int getTaskStatusListSize() {
      return (this.taskStatusList == null) ? 0 : this.taskStatusList.size();
    }

    public java.util.Iterator<TaskStatus> getTaskStatusListIterator() {
      return (this.taskStatusList == null) ? null : this.taskStatusList.iterator();
    }

    public void addToTaskStatusList(TaskStatus elem) {
      if (this.taskStatusList == null) {
        this.taskStatusList = new ArrayList<TaskStatus>();
      }
      this.taskStatusList.add(elem);
    }
     ...
     * the list of tasks status *
     */
    public heartbeat_args setTaskStatusList(List<TaskStatus> taskStatusList) {
      this.taskStatusList = taskStatusList;
      return this;
    }

    public void unsetTaskStatusList() {
      this.taskStatusList = null;
    }

    /** Returns true if field taskStatusList is set (has been assigned a value) and false otherwise */
    public boolean isSetTaskStatusList() {
      return this.taskStatusList != null;
    }

    public void setTaskStatusListIsSet(boolean value) {
      if (!value) {
        this.taskStatusList = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case TASK_STATUS_LIST:
        if (value == null) {
          unsetTaskStatusList();
        } else {
          setTaskStatusList((List<TaskStatus>)value);
        }
        break;
    ...
    public boolean equals(heartbeat_args that) {
      ...
      boolean this_present_taskStatusList = true && this.isSetTaskStatusList();
      boolean that_present_taskStatusList = true && that.isSetTaskStatusList();
      if (this_present_taskStatusList || that_present_taskStatusList) {
        if (!(this_present_taskStatusList && that_present_taskStatusList))
          return false;
        if (!this.taskStatusList.equals(that.taskStatusList))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_taskStatusList = true && (isSetTaskStatusList());
      list.add(present_taskStatusList);
      if (present_taskStatusList)
        list.add(taskStatusList);
    ...
    public int compareTo(heartbeat_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetTaskStatusList()).compareTo(other.isSetTaskStatusList());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTaskStatusList()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.taskStatusList, other.taskStatusList);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class heartbeat_argsStandardScheme extends StandardScheme<heartbeat_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.taskStatusList = new ArrayList<TaskStatus>(_list0.size);
                  TaskStatus _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new TaskStatus();
                    _elem1.read(iprot);
                    struct.taskStatusList.add(_elem1);
                  }
                  iprot.readListEnd();
                }
                struct.setTaskStatusListIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldEnd();
        if (struct.taskStatusList != null) {
          oprot.writeFieldBegin(TASK_STATUS_LIST_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.taskStatusList.size()));
            for (TaskStatus _iter3 : struct.taskStatusList)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class heartbeat_argsTupleScheme extends TupleScheme<heartbeat_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetTaskStatusList()) {
          {
            oprot.writeI32(struct.taskStatusList.size());
            for (TaskStatus _iter4 : struct.taskStatusList)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.taskStatusList = new ArrayList<TaskStatus>(_list5.size);
            TaskStatus _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new TaskStatus();
              _elem6.read(iprot);
              struct.taskStatusList.add(_elem6);
            }
          }
          struct.setTaskStatusListIsSet(true);
        }
