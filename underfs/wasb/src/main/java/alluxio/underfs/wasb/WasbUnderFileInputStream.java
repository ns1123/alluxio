...
/**
 * Wasb implementation for {@link java.io.InputStream}.
 */
@NotThreadSafe
public class WasbUnderFileInputStream extends FilterInputStream implements Seekable {
   ...
   */
  public WasbUnderFileInputStream(FSDataInputStream stream) {
    super(stream);
    mStream = stream;
  }
