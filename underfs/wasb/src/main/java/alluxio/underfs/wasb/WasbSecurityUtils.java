...
public final class WasbSecurityUtils {
  private static final Logger LOG = LoggerFactory.getLogger(WasbSecurityUtils.class);
  ...
  private WasbSecurityUtils() {}  // prevent instantiation
}
