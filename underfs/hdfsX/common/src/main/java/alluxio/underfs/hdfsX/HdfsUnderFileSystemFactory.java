...
/**
 * Factory for creating {@link AbstractHdfsUnderFileSystem}.
 *
 * It caches created {@link AbstractHdfsUnderFileSystem}s, using the scheme and authority pair as the key.
 */
@ThreadSafe
public final class HdfsUnderFileSystemFactory implements UnderFileSystemFactory {
  ...
  public UnderFileSystem create(String path, Object conf) {
    ...
    return new AbstractHdfsUnderFileSystem(new AlluxioURI(path), conf);
  }
