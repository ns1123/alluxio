...
package alluxio.underfs.hdfsDistr;
...
/**
 * Tests {@link AbstractHdfsUnderFileSystem}.
 */
public final class AbstractHdfsUnderFileSystemTest {

  private AbstractHdfsUnderFileSystem mHdfsUnderFileSystem;

  @Before
  public final void before() throws Exception {
    mHdfsUnderFileSystem = new AbstractHdfsUnderFileSystem(new AlluxioURI("file:///"), null);
  }

  /**
   * Tests the {@link AbstractHdfsUnderFileSystem#getUnderFSType()} method. Confirm the UnderFSType for
   * AbstractHdfsUnderFileSystem.
   */
  @Test
  ...
  /**
   * Tests the {@link AbstractHdfsUnderFileSystem#prepareConfiguration} method.
   *
  ...
  public void disableHdfsCache() throws Exception {
    ...
    AbstractHdfsUnderFileSystem hdfs =
        new AbstractHdfsUnderFileSystem(new AlluxioURI(underfsAddress), hadoopConf1);
