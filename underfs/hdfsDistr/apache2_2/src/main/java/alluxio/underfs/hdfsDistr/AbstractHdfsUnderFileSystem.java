 ...
 */
@ThreadSafe
public abstract class AbstractHdfsUnderFileSystem extends BaseUnderFileSystem
   ...
   */
  public AbstractHdfsUnderFileSystem(AlluxioURI uri, Object conf) {
    super(uri);
    ...
    if (hadoopConf.get("hadoop.security.authentication").equalsIgnoreCase(
      ...
      try {
        if ((loggerType.equalsIgnoreCase("MASTER_LOGGER")
          ...
          LOG.debug("Using proxyUgi: {}", proxyUgi);
