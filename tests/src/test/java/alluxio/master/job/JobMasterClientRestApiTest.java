...
public final class JobMasterClientRestApiTest extends RestApiTest {
  ...
  public void before() throws Exception {
    ...
    mServicePrefix = ServiceContants.SERVICE_PREFIX;
  }
  ...
  public void serviceNameTest() throws Exception {
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.SERVICE_NAME),
        NO_PARAMS, HttpMethod.GET, Constants.JOB_MASTER_CLIENT_SERVICE_NAME).run();
  }

  @Test
  public void serviceVersionTest() throws Exception {
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.SERVICE_VERSION),
  ...
  public void runJobTest() throws Exception {
    ...
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.RUN_JOB),
  ...
  public void cancelJobTest() throws Exception {
    ...
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.CANCEL_JOB),
  ...
  public void listJobsTest() throws Exception {
    ...
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.LIST), NO_PARAMS,
  ...
  public void listJobStatus() throws Exception {
    ...
    new TestCase(mHostname, mPort, getEndpoint(ServiceContants.LIST_STATUS),
