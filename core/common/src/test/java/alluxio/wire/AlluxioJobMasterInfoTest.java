...
public class AlluxioJobMasterInfoTest {

  @Test
  public void json() throws Exception {
    AlluxioJobMasterInfo alluxioJobMasterInfo = createRandom();
    ObjectMapper mapper = new ObjectMapper();
    AlluxioJobMasterInfo other = mapper
        .readValue(mapper.writeValueAsBytes(alluxioJobMasterInfo), AlluxioJobMasterInfo.class);
    checkEquality(alluxioJobMasterInfo, other);
  }

  @Test
  public void equals() {
    alluxio.test.util.CommonUtils.testEquals(AlluxioJobMasterInfo.class);
  }

  private void checkEquality(AlluxioJobMasterInfo a, AlluxioJobMasterInfo b) {
  ...
  private static AlluxioJobMasterInfo createRandom() {
    AlluxioJobMasterInfo result = new AlluxioJobMasterInfo();
