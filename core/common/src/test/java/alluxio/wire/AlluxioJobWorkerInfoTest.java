...
public class AlluxioJobWorkerInfoTest {

  @Test
  public void json() throws Exception {
    AlluxioJobWorkerInfo alluxioJobWorkerInfo = createRandom();
    ObjectMapper mapper = new ObjectMapper();
    AlluxioJobWorkerInfo other = mapper
        .readValue(mapper.writeValueAsBytes(alluxioJobWorkerInfo), AlluxioJobWorkerInfo.class);
    checkEquality(alluxioJobWorkerInfo, other);
  }
  ...
  private static AlluxioJobWorkerInfo createRandom() {
    AlluxioJobWorkerInfo result = new AlluxioJobWorkerInfo();
