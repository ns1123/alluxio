...
public final class FileInfo implements Serializable {
  ...
  private BlockHeader mBlockHeader;
  // ALLUXIO CS END
  ...
  protected FileInfo(alluxio.thrift.FileInfo fileInfo) {
    ...
    if (fileInfo.isSetBlockHeader()) {
      mBlockHeader = new BlockHeader(fileInfo.getBlockHeader());
    } else {
      mBlockHeader = null;
    }
    // ALLUXIO CS END
   ...
   * @return the updated {@link BlockHeader}
   */
  ...
  protected alluxio.thrift.FileInfo toThrift() {
    ...
    if (mBlockHeader != null) {
      info.setBlockHeader((mBlockHeader.toThrift()));
    }
    // ALLUXIO CS END
    return info;
  }
  ...
  public int hashCode() {
    return Objects.hashCode(mFileId, mName, mPath, mUfsPath, mLength, mBlockSizeBytes,
        ...
        mInMemoryPercentage, mLastModificationTimeMs, mTtl, mOwner, mGroup, mMode,
        // ALLUXIO CS ADD
        mReplicationMax, mReplicationMin, mCapability, mBlockHeader,
        // ALLUXIO CS END
  ...
  public String toString() {
    return Objects.toStringHelper(this).add("fileId", mFileId).add("name", mName).add("path", mPath)
        ...
        .add("capability", mCapability).add("blockHeader", mBlockHeader)
        // ALLUXIO CS END
