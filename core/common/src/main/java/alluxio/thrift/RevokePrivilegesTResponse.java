...
public class RevokePrivilegesTResponse implements org.apache.thrift.TBase<RevokePrivilegesTResponse, RevokePrivilegesTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<RevokePrivilegesTResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RevokePrivilegesTResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new RevokePrivilegesTResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RevokePrivilegesTResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RevokePrivilegesTResponse.class, metaDataMap);
  }

  public RevokePrivilegesTResponse() {
  }
   ...
   */
  public RevokePrivilegesTResponse(RevokePrivilegesTResponse other) {
  ...
  public RevokePrivilegesTResponse deepCopy() {
    return new RevokePrivilegesTResponse(this);
  }
  ...
  public RevokePrivilegesTResponse setPrivileges(List<TPrivilege> privileges) {
    this.privileges = privileges;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RevokePrivilegesTResponse)
      return this.equals((RevokePrivilegesTResponse)that);
    return false;
  }

  public boolean equals(RevokePrivilegesTResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RevokePrivilegesTResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RevokePrivilegesTResponse(");
    boolean first = true;
  ...
  private static class RevokePrivilegesTResponseStandardSchemeFactory implements SchemeFactory {
    public RevokePrivilegesTResponseStandardScheme getScheme() {
      return new RevokePrivilegesTResponseStandardScheme();
    }
  }

  private static class RevokePrivilegesTResponseStandardScheme extends StandardScheme<RevokePrivilegesTResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RevokePrivilegesTResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RevokePrivilegesTResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RevokePrivilegesTResponseTupleSchemeFactory implements SchemeFactory {
    public RevokePrivilegesTResponseTupleScheme getScheme() {
      return new RevokePrivilegesTResponseTupleScheme();
    }
  }

  private static class RevokePrivilegesTResponseTupleScheme extends TupleScheme<RevokePrivilegesTResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RevokePrivilegesTResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RevokePrivilegesTResponse struct) throws org.apache.thrift.TException {
