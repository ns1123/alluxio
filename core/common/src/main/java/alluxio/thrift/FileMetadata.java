...
public class FileMetadata implements org.apache.thrift.TBase<FileMetadata, FileMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<FileMetadata> {
  ...
  private static final org.apache.thrift.protocol.TField PHYSICAL_BLOCK_SIZE_FIELD_DESC = new org.apache.thrift.protocol.TField("physicalBlockSize", org.apache.thrift.protocol.TType.I32, (short)6);
  private static final org.apache.thrift.protocol.TField ENCRYPTION_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("encryptionId", org.apache.thrift.protocol.TType.I64, (short)7);
  ...
  private int physicalBlockSize; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PHYSICAL_BLOCK_SIZE((short)6, "physicalBlockSize"),
    ENCRYPTION_ID((short)7, "encryptionId");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // PHYSICAL_BLOCK_SIZE
          return PHYSICAL_BLOCK_SIZE;
        case 7: // ENCRYPTION_ID
  ...
  private static final int __PHYSICALBLOCKSIZE_ISSET_ID = 5;
  private static final int __ENCRYPTIONID_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.CHUNK_FOOTER_SIZE, new org.apache.thrift.meta_data.FieldMetaData("chunkFooterSize", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.PHYSICAL_BLOCK_SIZE, new org.apache.thrift.meta_data.FieldMetaData("physicalBlockSize", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    long encryptionId)
  {
    ...
    setPhysicalBlockSizeIsSet(true);
  ...
  public void clear() {
    ...
    setPhysicalBlockSizeIsSet(false);
    this.physicalBlockSize = 0;
  ...
  public void unsetPhysicalBlockSize() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PHYSICALBLOCKSIZE_ISSET_ID);
  }

  /** Returns true if field physicalBlockSize is set (has been assigned a value) and false otherwise */
  public boolean isSetPhysicalBlockSize() {
    return EncodingUtils.testBit(__isset_bitfield, __PHYSICALBLOCKSIZE_ISSET_ID);
  }

  public void setPhysicalBlockSizeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PHYSICALBLOCKSIZE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PHYSICAL_BLOCK_SIZE:
      if (value == null) {
        unsetPhysicalBlockSize();
      } else {
        setPhysicalBlockSize((Integer)value);
      }
      break;
  ...
  public boolean equals(FileMetadata that) {
    ...
    boolean this_present_physicalBlockSize = true;
    boolean that_present_physicalBlockSize = true;
    if (this_present_physicalBlockSize || that_present_physicalBlockSize) {
      if (!(this_present_physicalBlockSize && that_present_physicalBlockSize))
        return false;
      if (this.physicalBlockSize != that.physicalBlockSize)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_physicalBlockSize = true;
    list.add(present_physicalBlockSize);
    if (present_physicalBlockSize)
      list.add(physicalBlockSize);
  ...
  public int compareTo(FileMetadata other) {
    ...
    lastComparison = Boolean.valueOf(isSetPhysicalBlockSize()).compareTo(other.isSetPhysicalBlockSize());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPhysicalBlockSize()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.physicalBlockSize, other.physicalBlockSize);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("physicalBlockSize:");
    sb.append(this.physicalBlockSize);
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class FileMetadataStandardScheme extends StandardScheme<FileMetadata> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, FileMetadata struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // PHYSICAL_BLOCK_SIZE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.physicalBlockSize = iprot.readI32();
              struct.setPhysicalBlockSizeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileMetadata struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(PHYSICAL_BLOCK_SIZE_FIELD_DESC);
      oprot.writeI32(struct.physicalBlockSize);
      oprot.writeFieldEnd();
  ...
  private static class FileMetadataTupleScheme extends TupleScheme<FileMetadata> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, FileMetadata struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPhysicalBlockSize()) {
        optionals.set(5);
      }
