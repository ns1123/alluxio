...
public enum PropertyKey {
  ...
  USER_BLOCK_WORKER_CLIENT_THREADS(Name.USER_BLOCK_WORKER_CLIENT_THREADS, 5),
  ...
  USER_FILE_REPLICATION_DURABLE(Name.USER_FILE_REPLICATION_DURABLE, 1),
  // ALLUXIO CS END
  ...
  SECURITY_KERBEROS_SERVICE_NAME(Name.SECURITY_KERBEROS_SERVICE_NAME, ""),
  ...
  public static final class Name {
    ...
    public static final String SECURITY_KERBEROS_SERVICE_NAME =
