...
public enum PropertyKey {
  ...
  SECURITY_AUTHORIZATION_CAPABILITY_ENABLED(Name.SECURITY_AUTHORIZATION_CAPABILITY_ENABLED, true),
  ...
  SECURITY_AUTHORIZATION_CAPABILITY_KEY_LIFETIME_MS(
      Name.SECURITY_AUTHORIZATION_CAPABILITY_KEY_LIFETIME_MS, 5 * Constants.MINUTE_MS),
