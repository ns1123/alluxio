...
public final class MountTableTest {
  ...
  public void uri() throws Exception {
    // Test add()
    addMount("alluxio://localhost:1234/mnt/foo", "file://localhost:5678/foo", 1L);
    addMount("alluxio://localhost:1234/mnt/bar",
        "file://localhost:5678/bar", 2L);
  ...
  private void addMount(String alluxio, String ufs, long id) throws Exception {
    mMountTable.add(new AlluxioURI(alluxio), new AlluxioURI(ufs), id,
        MountOptions.defaults());
  }

  private boolean deleteMount(String path) {
    return mMountTable.delete(new AlluxioURI(path));
  }
}
