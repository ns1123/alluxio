...
public final class WebInterfaceLoginServlet extends HttpServlet {
  ...
  private static final int MAX_SESSIONS =
      ServerConfiguration.getInt(PropertyKey.WEB_LOGIN_SESSIONS);
  /**
   * Session timeout in milliseconds.
   */
  private static final long SESSION_TIMEOUT_MS =
      ServerConfiguration.getMs(PropertyKey.WEB_LOGIN_SESSION_TIMEOUT);
  /**
  ...
  public static final Cache<String, String> AUTHENTICATION_TOKENS =
      CacheBuilder.newBuilder().maximumSize(MAX_SESSIONS)
          .expireAfterAccess(SESSION_TIMEOUT_MS, TimeUnit.MILLISECONDS).build();
