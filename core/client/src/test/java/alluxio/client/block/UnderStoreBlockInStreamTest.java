...
public class UnderStoreBlockInStreamTest {
  ...
  public void before() throws IOException {
    ...
    os.close();
    mBlockStream = new UnderStoreBlockInStream(0, BLOCK_LENGTH, BLOCK_LENGTH, file.getAbsolutePath());
    mEOFBlockStream =
        new UnderStoreBlockInStream(BLOCK_LENGTH, BLOCK_LENGTH, BLOCK_LENGTH, file.getAbsolutePath());
  }
