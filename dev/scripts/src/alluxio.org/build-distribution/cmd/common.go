...
var hadoopDistributions = map[string]version{
	...
	"cdh-5.15": parseVersion("2.6.0-cdh5.15.0"),
	"cdh-5.16": parseVersion("2.6.0-cdh5.16.0"),
...
var ufsModules = map[string]module{
	...
	"ufs-cdh-5.15":   {"cdh-5.15", false, "-pl underfs/hdfs -Pufs-hadoop-2 -Dufs.hadoop.version=2.6.0-cdh5.15.0 -PhdfsActiveSync"},
	"ufs-cdh-5.16":   {"cdh-5.16", false, "-pl underfs/hdfs -Pufs-hadoop-2 -Dufs.hadoop.version=2.6.0-cdh5.16.0 -PhdfsActiveSync"},
